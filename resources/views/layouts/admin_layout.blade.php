        ...
        <div class="sidebar">
            <div>
                <div class="sidebar-header">
                    ...
                    <div class="mt-1" style="font-size:12px; color:rgba(255,255,255,0.4);">Admin Panel</div>
                </div>
                <div class="sidebar-nav">
                    <div class="nav-label">Main</div>
                    <a href="{{ route('admin.dashboard') }}" class="@yield('dashboard_active', '')">
                        <i class="fas fa-th-large"></i> Dashboard
                    </a>

                    <div class="nav-label">Management</div>
                    <a href="#" data-bs-toggle="collapse" data-bs-target="#produkMenu" aria-expanded="false">
                        <i class="fas fa-box"></i> Produk <i class="fas fa-chevron-down ms-auto" style="font-size:10px;"></i>
                    </a>
                    <div id="produkMenu" class="collapse">
                        <div class="collapse-inner">
                            <a href="{{ route('admin.products.index') }}"><i class="fas fa-list"></i> Lihat Produk</a>
                            <a href="{{ route('admin.products.create') }}"><i class="fas fa-plus"></i> Tambah Produk</a>
                        </div>
                    </div>

                    <a href="{{ route('admin.orders.index') }}" class="@yield('orders_active', '')">
                        <i class="fas fa-shopping-bag"></i> Orders
                    </a>
                    <a href="{{ route('admin.categories.index') }}" class="@yield('categories_active', '')">
